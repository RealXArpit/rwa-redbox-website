...
const PageHome = ({ setPage }: PageProps) => (
  <div>
    {/* HERO */}
      ...
      <div className="container relative z-10">
        <div className="max-w-[760px]">
          ...
          <div className="flex gap-3.5 flex-wrap">
            <Btn onClick={() => setPage("developers")}>I'm a Developer →</Btn>
            <Btn variant="outline" onClick={() => setPage("realtors")}>I'm a Realtor →</Btn>
          </div>
      ...
      <div className="container">
        <TwoCol
          left={<>
            ...
            <Btn variant="outline" onClick={() => setPage("about")}>About RealX →</Btn>
          </>}
          right={<div className="flex flex-col gap-4">
            {[
    ...
    <div className="py-20">
      <div className="container">
        <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
          ...
          <Btn variant="outline" onClick={() => setPage("faq")}>See All FAQs →</Btn>
        </div>
        ...
        <div className="text-center mt-8">
          <Btn variant="ghost" onClick={() => setPage("faq")}>View All FAQs — Developers, Realtors & Platform →</Btn>
        </div>
      </div>
    </div>
